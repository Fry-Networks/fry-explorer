...
export function HexHotspotsClient({ miners }: { miners: Miner[] | null }) {
    ...
    <div className="relative flex-1">
      {miners.map((miner) => (
        ...
        >
          ...
          <button
            onClick={() => setOpenModal(miner._id)}
          ...
          >
            ...
            >
              <DialogPanel className="relative w-full max-w-lg rounded-lg bg-white p-6 shadow-lg dark:bg-gray-800 sm:max-w-3xl">
                ...
                <div className="mb-5">
                  <Title>
                    {" "}
                    {`${miner.name} (${miner.nickname ?? "No nickname"})`}
                  </Title>
